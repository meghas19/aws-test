                        ...
                        <Card>
                            <CardBody>
                                        ...
                                        <Col md={10}>
                                            <div>
                                                ...
                                                <h3 className="m-0 mt-2 mb-2 text-center font-weight-bold">
                                                    SIKKIM TEACHER ELIGIBILITY TEST - JULY 2020
                                                </h3>
                                ...
                                <Row>
                                    <Col md={8}>
                                        <dl className="row mb-2 mt-3">
                                            <dt className="mb-4 col-sm-3 font-weight-bold">Roll No. :</dt>
                                            <dd className="mb-4 col-sm-9 font-weight-normal">
                                                {this.state.registerNumber}
                                            </dd>

                                            <dt className="mb-4 col-sm-3 font-weight-bold">Candidate Name :</dt>
                                            <dd className="mb-4 col-sm-9 font-weight-normal">
                                                {this.state.candidateName}
                                            </dd>

                                            <dt className="mb-4 col-sm-3 font-weight-bold">Category :</dt>
                                            <dd className="mb-4 col-sm-9 font-weight-normal">{this.state.category}</dd>

                                            <dt className="mb-4 col-sm-3 font-weight-bold">Gender :</dt>
                                            <dd className="mb-4 col-sm-9 font-weight-normal">{this.state.gender}</dd>

                                            <dt className="mb-4 col-sm-3 font-weight-bold">Father's Name :</dt>
                                            <dd className="mb-4 col-sm-9 font-weight-normal">
                                                {this.state.father_fname + ' ' + this.state.father_lname}
                                            </dd>

                                            <dt className="mb-4 col-sm-3 font-weight-bold">Mother's Name :</dt>
                                            <dd className="mb-4 col-sm-9 font-weight-normal">
                                                {this.state.mother_fname + ' ' + this.state.mother_lname}
                                            </dd>
                                        </dl>
                                    </Col>
                                    <Col md={4}>
                                ...
                                <Row>
                                    <div className="table-responsive">
                                        <table className="table mt-4 text-center" style={{ border: '2px solid #000' }}>
                                            <tr>
                                                <td
                                                    colspan="3"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    style={{ border: '1px solid #000' }}>
                                                    <Row>
                                                        <Col md={3}>Language 1:</Col>
                                                        <Col md={9}>English</Col>
                                                    </Row>
                                                </td>
                                                <td style={{ border: '1px solid #000' }}>30</td>
                                                <td style={{ border: '1px solid #000' }}>25</td>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    style={{ border: '1px solid #000' }}>
                                                    <Row>
                                                        <Col md={3}>Language 2:</Col>
                                                        <Col md={9}>Sikkimese</Col>
                                                    </Row>
                                                </td>
                                                <td style={{ border: '1px solid #000' }}>30</td>
                                                <td style={{ border: '1px solid #000' }}>25</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style={{ border: '1px solid #000' }}>125</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    className="ml-8 font-weight-bold text-left"
                                ...
                                <Row>
                                    <Col md={8}>
                                        <dl className="row mb-2 mt-3">
                                            ...
                                            <dt className="mb-2 col-sm-3 font-weight-bold">Result Declared on :</dt>
                                            <dd className="mb-2 col-sm-9 font-weight-normal">
                                                {this.state.resultDate}
                                            </dd>

                                            <dt className="mb-2 col-sm-3 font-weight-bold">Dated :</dt>
                                            <dd className="mb-2 col-sm-9 font-weight-normal">{Date.now()}</dd>
                                        </dl>
                                    </Col>
                                    <Col md={4}>
                                        <div className="table-responsive text-center">
