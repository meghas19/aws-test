...
import { isUserAuthenticated, loginUserFireBase } from '../../helpers/authUtils';
...
class Login extends Component {
    ...
    loginUserData = () => {
        console.log('here air');
        loginUserFireBase(this.state.username, this.state.password);
        setTimeout(() => {
